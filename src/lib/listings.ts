...
export const LISTINGS: Listing[] = [
  ...
  },
  {
    ...
    priceLabel: "159 000 €",
    isRental: false,
    title: "T2 investissement locatif rentable. Proche gare",
    propertyType: "appartement",
    surface: 42,
    rooms: 2,
    bedrooms: 1,
    ...
    cellar: true,
    dpe: "C",
    features: ["Loué 580 €/mois", "Cave", "Proche gare"],
    neighborhood: "Centre. Proche gare TGV",
    description:
      "Appartement T2 idéal investisseur. Actuellement loué 580 €/mois à locataire sérieux. Séjour lumineux, chambre séparée, cuisine équipée, salle d'eau récente. Cave privative. Excellent rendement, secteur très demandé proche de la gare TGV et des transports.",
  ...
  },
  {
    ...
    priceLabel: "489 000 €",
    isRental: false,
    title: "Villa contemporaine avec piscine. Bezannes",
    propertyType: "villa",
    surface: 165,
    rooms: 6,
    bedrooms: 4,
    ...
    cellar: false,
    dpe: "A",
    features: ["Piscine", "Garage double", "Terrain 600 m²"],
    neighborhood: "Bezannes",
    description:
      "Magnifique villa contemporaine récente sur terrain clos de 600 m² avec piscine chauffée. Vaste séjour cathédrale, cuisine américaine équipée haut de gamme, 4 chambres dont suite parentale avec dressing. Garage double, panneaux solaires. DPE A, prestations soignées. Quartier résidentiel calme à 10 min du centre de Reims.",
  ...
  },
  {
    ...
    priceLabel: "115 000 €",
    isRental: false,
    title: "Studio hypercentre meublé. Idéal investisseur",
    propertyType: "studio",
    surface: 26,
    rooms: 1,
    bedrooms: null,
    ...
    furnished: true,
    dpe: "C",
    features: ["Meublé", "Ascenseur", "Place d'Erlon"],
    neighborhood: "Hypercentre. Place d'Erlon",
    description:
      "Studio meublé entièrement équipé dans immeuble avec ascenseur. Coin nuit, cuisine équipée, salle d'eau moderne. Très bien situé en hypercentre, à deux pas de la place d'Erlon, des commerces et des transports. Idéal pour investissement locatif courte ou longue durée.",
  ...
  },
  {
    ...
    priceLabel: "375 000 €",
    isRental: false,
    title: "Maison de caractère avec jardin. Cormontreuil",
    propertyType: "maison",
    surface: 145,
    rooms: 6,
    bedrooms: 4,
    ...
    cellar: true,
    dpe: "C",
    features: ["Jardin 320 m²", "Garage", "Cheminée"],
    neighborhood: "Cormontreuil",
    description:
      "Belle maison de caractère pleine de charme sur un terrain arboré de 320 m². Séjour double avec cheminée, salle à manger, cuisine équipée. 4 chambres à l'étage, deux salles de bain. Cave, garage et atelier. Quartier résidentiel calme à 8 minutes du centre de Reims, écoles et commerces à proximité.",
