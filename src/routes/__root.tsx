...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sabrina Heydel - Systemes digitaux sur mesure" },
      { name: "description", content: "Demo Systeme Immobilier" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Sabrina Heydel - Systemes digitaux sur mesure" },
      { property: "og:description", content: "Demo Systeme Immobilier" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Sabrina Heydel - Systemes digitaux sur mesure" },
      { name: "twitter:description", content: "Demo Systeme Immobilier" },
